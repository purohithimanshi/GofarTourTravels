 ...
 */
package com.gofar.core.constants;

/**
 * Global class for all GofarCore constants. You can add global constants for your extension into this class.
 */
public final class GofarCoreConstants extends GeneratedGofarCoreConstants
{
	public static final String EXTENSIONNAME = "gofarcore";


	private GofarCoreConstants()
	{
		//empty
	}
