 ...
 */
package com.gofar.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(GofarFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(GofarFulfilmentProcessConstants.PARENT_PROCESS);
