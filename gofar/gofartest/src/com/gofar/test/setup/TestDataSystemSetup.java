...
import com.gofar.test.constants.GofarTestConstants;
import com.gofar.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = GofarTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/gofartest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/gofartest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/gofartest/import/cstickets.impex");
			...
			importImpexFile(context, "/gofartest/import/csquotes.impex");
		}
	}
}
